...
def trading_config_to_session_params(config: "TradingConfig") -> Dict[str, Any]:
    return {
        ...
        "choppy_time_exit_bars": int(config.choppy_time_exit_bars),
        "stale_trade_be_bars": int(config.stale_trade_be_bars),
        "stale_trade_be_pnl_threshold_pct": float(config.stale_trade_be_pnl_threshold_pct),
