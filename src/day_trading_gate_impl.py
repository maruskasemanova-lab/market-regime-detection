...
class GateEvaluationEngine:
    ...
    _HEADWIND_CONTRARIAN_STRATEGIES = frozenset({
    ...
    def cross_asset_headwind_threshold_boost(
        ...
        *,
        ...
        # Sector-relative underperformance reinforces macro headwind.
        ...
        # Contrarian strategies trade against the market — cap headwind penalty.
