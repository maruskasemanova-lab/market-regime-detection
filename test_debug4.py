# Just mocking what calculate_intrabar_1s_snapshot does
raw_quotes = [
...
for item in raw_quotes:
    second = int(item["s"])
    mid = (item["bid"] + item["ask"]) / 2.0
    rows.append((second, mid, 0.0))
...
print("long move pct:", window_long_move_pct)
print("long push ratio:", window_long_push_ratio)
